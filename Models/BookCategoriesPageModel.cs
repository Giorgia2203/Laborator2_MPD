...
namespace Laborator2_MPD.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Laborator2_MPDContext context, Book book)
        {
        ...
        public void UpdateBookCategories(Laborator2_MPDContext context, string[] selectedCategories, Book bookToUpdate)
        {
